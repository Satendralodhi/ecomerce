            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === "lodhisatendra54@gmail.com" ? <div className="flow-root">
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                 ...
                 {user ?  <Link to={'/order'} className="text-sm font-medium text-gray-700 " style={{ color: mode === 'dark' ? 'white' : '', }}>
                    ...
                    {user?.user?.email === 'lodhisatendra54@gmail.com' ? 
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
                    <img
                      src="https://th.bing.com/th?id=OIP.YHufaYYtdq8EtHQRPAx_9QHaE8&w=306&h=204&c=8&rs=1&qlt=90&o=6&dpr=1.3&pid=3.1&rm=2"
                      alt=""
                      className="block h-auto w-5 flex-shrink-0"
                    />
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 ">
                    <img
                      className="inline-block w-10 h-10 rounded-full"
                      src="https://media.licdn.com/dms/image/D5603AQFvBIcvhtMLuA/profile-displayphoto-shrink_200_200/0/1691832667664?e=2147483647&v=beta&t=GFfY7fOQz0w80PoE0f7HN7jyBOu3F_SNqamd4E3mWwA"
                      alt="satendra" />
                  </a>
                </div>
